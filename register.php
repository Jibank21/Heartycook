...
<head>
  <meta charset="UTF-8">
    <title>Cook Registration Form</title>
        ...
        <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyDNyf6BlIC4NJDQZqavP4Kz0fdW0nKE_5o"></script>
      <script>
      var searchInput = 'add';
...
<body>
  ...
  <div class="middle" style="margin:0px auto; border:1px solid #F8F9FA;  width:800px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ED2553;border-radius:10px 10px 10px 10px;" role="tablist">
		  ...
		  <li class="nav-item">
             <a class="nav-link " id="login-tab" style="color:#BDDEFD;" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="false">Log In</a>
          </li>
       </ul>
	   <br><br>
	   <!--tab 1 starsts-->
	      ...
	      <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="profile-tab">
			    <div class="footer" style="color:red;"><?php if(isset($loginmsg)){ echo $loginmsg;}?></div>
                    ...
                    <div class="form-group">
                            ...
                            <input type="tel" class="form-control"  id="phone" value="<?php if(isset($phone)) { echo $phone;}?>" placeholder="Enter phone number " name="phone" required>
                      </div>
	                 <div class="form-group">
	                 ...
	                 <div class="form-group">
                          <input type="file"  name="image" required>Upload image 
                     </div>
			...
			<div class="tab-pane fade" id="login" role="tabpanel" aria-labelledby="home-tab">
			   <a href="cook_login.php"><button type="button" style="padding:10px;  width:200px; margin-top:30%; margin-left:40%; margin:0px auto;" class="btn btn-outline-primary" name="login" value="Log In">Log In</button></a>
