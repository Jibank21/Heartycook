...
<head>
  <meta charset="UTF-8">
    <title>Deliver driver Registration Form</title>
	  ...
	  <div class="tab-content" id="myTabContent">
	      <div class="tab-pane fade show active" id="register" role="tabpanel" aria-labelledby="profile-tab">
			...
			<div class="tab-pane fade" id="login" role="tabpanel" aria-labelledby="home-tab">
			   <a href="delivery_login.php"><button type="button" style="padding:10px;  width:200px; margin-top:30%; margin-left:40%; margin:0px auto;" class="btn btn-outline-primary" name="login" value="Log In">Log In</button></a>
