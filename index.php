...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/creamy-pasta-with-mushrooms-and-olives.jpg" alt="Mushroom lover" class="d-block w-100"
	  hight="500px">
      <div class="carousel-caption">
        <h3>Mushroom Lover</h3>
        <p>We had such a great Mushroom with Olives!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/photo-1533622597524-a1215e26c0a2.jpg" alt="Salad" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Salad lover</h3>
        <p>Thank you for Awsome salad!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/delish-street-corn-nachos-still001-1557431305.jpg" alt="vegan" class="d-block w-100" hight="500px">
      <div class="carousel-caption">
        <h3>Perfect For Nacho lover</h3>
        <p>We love to serve nacho!</p>
      </div>   
    </div>
  </div>
