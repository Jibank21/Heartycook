...
{
	header("location:cook_login.php?msg=You Must Login First");
}
}
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:green;font-family: 'Permanent Marker', cursive;"><b>Hearty Cook</b>t</span></a>
    <?php
	if(!empty($id))
	{
	?>
