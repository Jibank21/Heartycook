...
<style>
	...
	<!--navbar start-->
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
			...
			<ul class="navbar-nav ml-auto">
				...
				<?php
					...
					{
					?>
					<a href="customer/index.php?msg=you must be login first"><span style="color:red; font-size:30px;"><i class="fa fa-shopping-cart" aria-hidden="true"><span style="color:red;" id="cart"  class="badge badge-light">0</span></i></span></a>
		...
		<h1 style="color:#fcffff; text-align:center; text-transform:uppercase;">we do this by</h1>
		<h3 style="color:#fcffff; text-align:center; text-transform:uppercase;">Helping people discover great places around them.</h3>
		<p style="color:#fcffff; text-align:center; font-size:25px;">Our team gathers information from every cook on a regular basis to ensure our data is fresh. Our vast community of food lovers share their reviews and photos, so you have all that you need to make an informed choice.</p>

		<h3 style="color:#fcffff; text-align:center; text-transform:uppercase;">Building amazing experiences around dining.</h3>
		<p style="color:#fcffff; text-align:center; font-size:25px;">Starting with information for over 1 million cooks (and counting) globally, we're making dining smoother and more enjoyable with services like online ordering and table reservations.</p>

		<h3 style="color:#fcffff; text-align:center; text-transform:uppercase;">Enabling cooks to create amazing experiences.</h3>
		<p style="color: #fcffff; text-align:center; font-size:25px;">With dedicated engagement and management tools, we're enabling cooks to spend more time focusing on food itself, which translates directly to better dining experiences.</p>
		</div>
