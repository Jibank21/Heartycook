...
if(!isset($_SESSION['id']))
{
	header("location:cook_login.php?msg=Please Login To continue");
}
else
{
...
{   if(!file_exists("../image/cook/".$id."/foodimages"))
	{
		$dir=mkdir("../image/cook/".$id."/foodimages");
	}
...
{   if(isset($_SESSION['id']))
	...
	{
		move_uploaded_file($_FILES['food_pic']['tmp_name'],"../image/cook/$id/foodimages/".$_FILES['food_pic']['name']);
	}
	else{
		echo "failed";
	}
            ...
            <div class="tab-pane fade show active" id="viewitem" role="tabpanel" aria-labelledby="home-tab">
			 ...
			 <th>Update item Details </th>
			   <?php
				...
				<td><img src="<?php echo 'image/cook/'.$id.'/foodimages/'.$row['fldimage'];?>" height="100px" width="150px"></td>
				...
				<a href="cook_delete_food.php?food_id=<?php echo $row['food_id'];?>"><button type="button" class="btn btn-warning">Delete </button></a>
